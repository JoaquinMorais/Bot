...
class Preguntados:
    def __init__(self):
        ...
        'En un Año viciesto, ¿Cuantos dias le toma a la tierra dar una vuelta a la órbita del sol?',
        ...
        '¿Cual es la canción mas reproducida en Spotify hasta el momento?',
        '¿Cuantas teclas tiene un piano?',
        '¿Que banda americana se llamaba originalmente, “Kara’s Flowers”?',
        '¿Que equipo de fútbol se le conoce como ‘The Red Devils’?',
